(module
 ...
 (func $src/assembly/wasm/moveRect (param $0 i32) (param $1 i32)
  ...
  i32.sub
  local.set $8
  block $src/assembly/wasm/clip|inlined.0 (result i32)
   global.get $src/assembly/wasm/WIDTH
   local.set $4
   i32.const 0
   global.get $src/assembly/wasm/XMIN
  ...
  local.set $6
  block $src/assembly/wasm/clip|inlined.1 (result i32)
   global.get $src/assembly/wasm/HEIGHT
   local.set $4
   i32.const 0
   local.get $1
  ...
  local.set $4
  block $src/assembly/wasm/clip|inlined.2 (result i32)
   global.get $src/assembly/wasm/WIDTH
   local.set $5
   i32.const 0
   local.get $3
  ...
  i32.sub
  local.set $12
  block $src/assembly/wasm/clip|inlined.3 (result i32)
   global.get $src/assembly/wasm/HEIGHT
   local.set $5
   i32.const 0
   local.get $2
  ...
  select
  if
   block $src/assembly/wasm/clearRect|inlined.1
    local.get $0
    local.set $5
    local.get $2
    local.set $0
    ...
    local.get $1
    select
    br_if $src/assembly/wasm/clearRect|inlined.1
    local.get $1
    i32.const 2
    i32.shl
    local.set $1
