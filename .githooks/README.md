...
The [`pre-commit`](./pre-commit) hook auto-formats staged files with Prettier or Ruff, and stages the result. It stages the whole file, so a file you staged only part of gets committed whole.
